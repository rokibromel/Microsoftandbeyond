...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "Microsoftandbeyond" -ForegroundColor Yellow -NoNewline; Write-Host " to see All Microsoft O365 related admin & user tutorials. ~~" -ForegroundColor Green `n
